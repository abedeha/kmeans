        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/tugas-akhir/store" method="post" role="form">
                        <?= csrf_field() ?>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" name="tahun_terbit" id="tahun_terbit" class="form-control" value="<?= old('tahun_terbit') ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="id_bidang_studi" class="form-control">
                                        <?php foreach (bidangStudi() as $key => $value) : ?>
                                            <option value="<?= $value['id_bidang_studi'] ?>"><?= $value['bidang_studi'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
