    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <p><b>Perubahan Centroid Setiap Iterasi:</b></p>
                    <canvas id="iterationChart2"></canvas>
                </div>
            </div>
        </div>
...
<script>
    const warna = [
        ...
        'rgba(199, 199, 199, 0.5)', 'rgba(83, 102, 255, 0.5)', 'rgba(143, 163, 54, 0.5)',
        'rgba(214, 92, 92, 0.5)'
    ];
    ...
    iterations.forEach((iteration, i) => {
        const centroids = iteration.centroids;
        const data = centroids.map(c => ({
            x: c.x,
            y: c.y,
            r: 5
        }));

        iterationData.push(createDataset(`Iterasi ${i + 1}`, data, warna[i % warna.length]));
    });

    new Chart(document.getElementById('iterationChart2'), {
        type: 'bubble',
        data: {
            datasets: iterationData
        },
        options: {
            scales: {
                x: {
